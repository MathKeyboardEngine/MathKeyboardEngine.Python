...
def test_gets_bracket_pair_content():
    for testinput in [(r'\frac{', '}', r'\frac{1}{2}', '1', '{2}'), (r'\frac{', '}', r'\frac{123}{456}', '123', '{456}'), (r'\frac{', '}', r'\frac{\frac{1}{1-x}}{x}', r'\frac{1}{1-x}', '{x}'), (r'\frac{', '}', r'\frac{TEST\right}and\}\}\{}{x}', r'TEST\right}and\}\}\{', '{x}'), (r'\frac{', '}', r'\frac{1}{2}3', '1', '{2}3')]:
        opening = testinput[0]
